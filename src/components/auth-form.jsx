    ...
    return(
        <>
            <form className='loginForm'>
                ...
                <label>E-mail <input type="email" placeholder="Email" value={email} onChange={e => setEmail(e.target.value)} /></label><br/>
                <label>Hasło <input type="password" placeholder="Hasło" value={password} onChange={e => setPassword(e.target.value)} /></label><br/>

                <button type='button' className='formButton' onClick={handleSubmit}>{isLogin ? "Zaloguj się" : "Zarejestruj się"}</button><br/>
